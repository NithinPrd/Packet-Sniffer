...
# output = subprocess.check_output('./sniffer', shell=True)
# print 'Given output is ' + output
...
def stop():
    ...
    print("Packets intercepted: " + str(idx))
...
stop = Button(app, text="Stop Scan", command=stop)

button2 = tk.Button(app, text='Log Intercept', command=newLog)
